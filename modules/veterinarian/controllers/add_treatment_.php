...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        $sql = "INSERT INTO treatment (treatment_id,vet_id, pet_id, symptoms, definitive_diagnosis, special_comments, followup_date, treatment_bill)
         VALUES ('$next_t_id','E002', 'P001', '$symptoms', '$def_diagnosis', '$sp_comment', '$followup_date', '5000.00')";
                ...
                <div class="treatment-content">
                    ...
                    <div class="treatment-data">
                        <div class="t-symptoms">
                            ...
                            <textarea class="add-symptoms" onclick="symptomClick()" name="symptoms" placeholder="..."></textarea>

                            <label for="textarea">Definitive Diagnosis</label>
                            <textarea class="add-diagnosis" onclick="diagnosisClick()" name="def_diagnosis"></textarea>
